...
<body>
    ...
    <div class="container">
        ...
        <form action="displayHtbreaker.php" method="post" name="myform" id="myForm">
            <div class="f-group">
        ...
        <form action="displayHtbreaker.php" method="post">  
            <div class="f-group">
 ...
 if(!$con)
 {
    ...
    if($num>0){
        ...
        while($row=mysqli_fetch_assoc($result)){
            ...
            <td>".$row['Type'] ."</td>
            <td>".$row['Make'] ."</td>
            <td>".$row['Manufacturing Year'] ."</td>
            <td>".$row['Serial Number'] ."</td>
            <td>".$row['Capacity'] ."</td>
            <td>".$row['Energization date'] ."</td>
            <td>".$row['Warranty'] ."</td>
            ";
        }
    }
