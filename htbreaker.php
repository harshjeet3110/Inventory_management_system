...
if(isset($_POST['Type'])){
    ...
    $sql="INSERT INTO `htbreaker`.`htbreaker` (`Type`, `Make`, `Manufacturing Year`, `Serial Number`, `Capacity`, `Energization Date`, `Warranty`) VALUES ('$Type', '$Make', current_timestamp(), '$SerialNumber', '$Capacity', current_timestamp(), current_timestamp());";
    // echo $sql;
...
<body>
  ...
  ?>
    <h3 class="">HT Breakers</h3>
    <form action="htbreaker.php" method="post">
      <div class="block">
