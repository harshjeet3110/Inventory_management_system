...
if(isset($_POST['Type'])){
    ...
    $sql="INSERT INTO  `tower`. `tower` (`Type`, `Make`, `ManufacturingYear`, `SerialNumber`, `Capacity`, `EnergizationDate`, `Warranty`) VALUES ('$Type', '$Make', current_timestamp(), '$SerialNumber', '$Capacity', current_timestamp(), current_timestamp());";
    // echo $sql;
